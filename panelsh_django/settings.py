"""
Django settings for panelsh_django project.
...
INSTALLED_APPS = [
    'panelsh_app.apps.PanelshAppConfig',
    'drf_spectacular',
    'rest_framework',
    'api.apps.ApiConfig',
...
ROOT_URLCONF = 'panelsh_django.urls'
...
WSGI_APPLICATION = 'panelsh_django.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': (
            '/data/.panelsh/test.db' if getenv('ENVIRONMENT') == 'test'
            else '/data/.panelsh/panelsh.db'
        ),
    },
}
...
STATIC_ROOT = '/data/panelsh/staticfiles'
...
DBBACKUP_STORAGE_OPTIONS = {'location': '/data/.panelsh/backups'}
DBBACKUP_HOSTNAME = 'panelsh'
