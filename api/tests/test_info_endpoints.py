...
class InfoEndpointsTest(TestCase):
    ...
    @mock.patch(
        'api.views.v2.is_balena_app',
        return_value=True,
    )
    @mock.patch(
        'api.views.v2.fetch_balena_supervisor_status',
    ...
    @mock.patch(
        'api.views.v2.getenv',
        return_value='balenauser'
    )
    @mock.patch('api.views.v2.os.getenv')
    def test_info_v2_endpoint_balena(
        self,
        os_getenv_mock,
        getenv_mock,
        get_node_ip_mock,
        ...
        get_load_avg_mock,
        is_up_to_date_mock,
        fetch_balena_supervisor_status_mock,
        is_balena_app_mock,
    ):
        os_getenv_mock.side_effect = lambda key, default=None: {
            'BALENA_DEVICE_TYPE': 'raspberrypi5-64',
        }.get(key, default)
        ...
        expected_data = {
            ...
            'host_user': 'balenauser',
            'balena_supervisor_status': {'status': 'ok'},
        }
        self._assert_response_data(data, expected_data)
