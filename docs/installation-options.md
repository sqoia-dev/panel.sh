...
The quickest way to get started on supported devices is to use [Raspberry Pi Imager](https://www.panelsh.io/blog/2022/12/13/panelsh-and-panelsh-now-in-rpi-imager/), where you can find Panelsh under `Other specific-purpose OS`.
...
> [!IMPORTANT]
> This option is recommended for those who want to install Panelsh without touching the
...
[Fleets for Good](https://hub.balena.io/fleets-for-good). With that, you may find it hard to find the Panelsh images on the marketplace. In the meantime,
here are the links to the images:

* [Raspberry Pi 5](https://hub.balena.io/fleets-for-good/2209774/panelsh-pi5)
* [Raspberry Pi 4](https://hub.balena.io/fleets-for-good/1971389/panelsh-pi4)
* [Raspberry Pi 3](https://hub.balena.io/fleets-for-good/1971388/panelsh-pi3)
* [Raspberry Pi 2](https://hub.balena.io/fleets-for-good/1971385/panelsh-pi2)
* [Raspberry Pi 1](https://hub.balena.io/fleets-for-good/1971378/panelsh-pi1)
...
You can find the latest release [here](https://github.com/Panelsh/Panelsh/releases/latest). From there, you can download the disk image that you need and flash it to your SD card.
...
> [!NOTE]
> We started to release the images in `.zst` format in [v0.20.0](https://github.com/Panelsh/Panelsh/releases/tag/v0.20.0) so that the images are smaller in size. Using `zip` with the `-9` flag won't make the each of the images smaller than 2 GB.
>
...
Starting with [v0.19.0](https://github.com/Panelsh/Panelsh/releases/tag/v0.19.0), devices installed using this option will be pinned to the version that you've downloaded. This means that the devices will still be in the same version even if a new release (e.g., v0.19.1, etc.) is available.
...
>   * On our [forums](https://forums.panelsh.io)
>   * As a [GitHub issue](https://github.com/Panelsh/Panelsh/issues)
>   * In [GitHub Discussions](https://github.com/Panelsh/Panelsh/discussions)
...
![install-panelsh-gif](/docs/images/install-panelsh.gif)
...
Select this option if you want to install a pinned version of Panelsh. You'll be prompted to enter
a specific tag to install. You can find the tags in the
[releases](https://github.com/Panelsh/Panelsh/releases) page.
...
```
Please reboot and run `/home/$USER/panel.sh/bin/upgrade_containers.sh` to complete the installation.
...
to deploy Panelsh on your own Balena fleet.
...
to deploy Panelsh on a Pi5 with an SSD
